...
if __name__ == '__main__':
    ...
    print(os.path.exists(f'../GT_supervoxels/output/init_label_large_region{file_supfix}_wo_dyn_objects.json'))
    with open(f'output/init_label_large_region{file_supfix}_wo_dyn_objects.json', 'r') as f:
        labeled_regions = json.load(f)

    with open(f'../GT_supervoxels/output/init_ulabel_large_region{file_supfix}_wo_dyn_objects.json', 'r') as f:
        unlabeled_regions = json.load(f)

    with open(f'../GT_supervoxels/output/dynamic_instances{file_supfix}.json', 'r') as f:
        dynamic_instances_dict = json.load(f)
    with open(f'../GT_supervoxels/output/scene_instances{file_supfix}.json', 'r') as f:
