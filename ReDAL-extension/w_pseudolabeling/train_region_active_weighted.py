...
class Trainer(BaseTrainer):
    ...
    def train(self, active_set):
        ...
        c_weights = active_set.label_dataset.compute_weight(self.args.num_classes, self.args.ignore_idx)
        self.loss_fun = torch.nn.CrossEntropyLoss(weight=c_weights.to(torch.device('cuda:0')), ignore_index=self.args.ignore_idx)
