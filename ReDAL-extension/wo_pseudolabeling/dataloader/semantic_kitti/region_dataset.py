    ...
    def __init__(self, data_path, voxel_size, imageset='train', init_lst=None, mode='ORG'):
        ...
        if imageset == 'active-label':
            if self.mode == 'ORG':
                ...
                with open('dataloader/semantic_kitti/init_data/init_label_large_region_GT.json') as f:
                    json_dict = json.load(f)
            else:
            ...
            if self.mode == 'ORG':
                ...
                with open('dataloader/semantic_kitti/init_data/init_ulabel_large_region_GT.json') as f:
                    json_dict = json.load(f)
            else:
                assert False, f'Unrecognised self.mode'
        else:
